...
let HomeComponent = class HomeComponent {
    constructor(portalService, userAuthService, router) {
        this.portalService = portalService;
        this.userAuthService = userAuthService;
        this.router = router;
...
let ChatListComponent = class ChatListComponent {
    constructor(answerService, portalService) {
...
let QuestionComponent = class QuestionComponent {
    // canAutoScroll = true;
    constructor(questionService, chatServise, portalService, route) {
        this.questionService = questionService;
...
let SettingsComponent = class SettingsComponent {
    constructor(nickNameService, portalService) {
        this.nickNameService = nickNameService;
        this.portalService = portalService;
