...
let HomeComponent = class HomeComponent {
    ...
    startEvent(_a) {
        var { counter } = _a, portal = tslib__WEBPACK_IMPORTED_MODULE_0__["__rest"](_a, ["counter"]);
...
let QuestionComponent = class QuestionComponent {
    ...
    action(item, i) {
        ...
        if (item.isLiked) {
            ...
            item.likes = t - 1;
            this.chatServise.sendLikeCount({ index: i, likes: t - 1, nicknameId: us_erID, questionId: item.id, portalId }, "minus");
        }
        else {
            item.isLiked = true;
            ...
            const t = Object(src_app_HELPERS_extractLikes__WEBPACK_IMPORTED_MODULE_4__["extractLikes"])(item);
            item.likes = t + 1;
            this.chatServise.sendLikeCount({ index: i, likes: t + 1, nicknameId: us_erID, questionId: item.id, portalId }, "plus");
        }
    }
...
let ProfileComponent = class ProfileComponent {
    constructor(route, userService, userAuthService) {
        this.route = route;
        this.userService = userService;
        this.userAuthService = userAuthService;
    }
...
let UserRegistrationComponent = class UserRegistrationComponent {
    constructor(router, userService, authService, formBuilder) {
        this.router = router;
        this.userService = userService;
        this.authService = authService;
        this.formBuilder = formBuilder;
